...
//     for(key in myerr  ) {
//         console.info(myerr[key]['message'])
//     }

// })

// Path `name` (`爷`) is shorter than the minimum allowed length (4).
// Path `age` (10000) is more than maximum allowed value (100).
//  author 传入的值不符合验证规则
// `vue` is not a valid enum value for path `category`.
