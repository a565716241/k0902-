$(function() {
    ...
    // 如果 document 距离顶部的高度大于 recommend 距离顶部的高度   那么就显示左边的小导航栏
    ...
    $(document).scroll(function() {
        ...
        console.log(dTop)
            //如果document 距离顶部的高度(动态的) 大于  recommend  距离顶部的高度  那么就显示左边的小导航栏
    ...
    //2 点击每个小的li  实现对应版本滚动 并且当前的小li高亮
